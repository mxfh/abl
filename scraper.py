...
orte = []
events = []
tageins = datetime.datetime(1989, 8, 1)  ## beginn der ersten woche erste monat 1.8.89 relativ zu 13.8.89
    ...
    for ortli in soup.find_all("li"): 
        ...
        for evententries in soup.find_all("div", class_="entry"): 
            ...
            events.append({
                ...
                "wochenseit": (ttuple - tageins).weeks,
                "monateseit": (ttuple - tageins).months,
